...
pub struct App {
    ...
    pub assistant_output_persisted: bool,
    pub assistant_last_persist_range: Option<(usize, usize)>,
...
impl App {
    pub fn new(width: u16, height: u16, once: bool) -> Self {
        Self {
            ...
            assistant_output_persisted: false,
            assistant_last_persist_range: None,
